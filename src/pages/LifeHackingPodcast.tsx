  ...
  const episodes: PodcastEpisode[] = [
    {
      ...
      description: 'W tym odcinku omawiam praktyczne podejście do budowy systemu produktywności, który nie tylko działa na papierze, ale faktycznie wspiera Cię w codziennych wyzwaniach. Poznasz konkretne narzędzia i techniki.',
    ...
    },
    {
      ...
      description: 'Czy wiesz, że bycie ekspertem we wszystkim może być Twoją największą słabością? W tym odcinku omawiam, jak strategicznie wybierać obszary, w których warto być przeciętnym, aby ekscelować w tym, co naprawdę ma znaczenie.',
    ...
    },
    {
      ...
      description: 'Największym wyzwaniem nie jest zdobywanie wiedzy, ale jej wdrażanie. W tym odcinku przedstawiam sprawdzony protokół, który pomaga przejść od "wiem jak" do "robię to" w zaledwie 72 godziny.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto mb-12">
            <p className="text-lg text-deep-charcoal dark:text-silver-mist mb-6">
              Jeśli jesteś freelancerem, przedsiębiorcą, prawnikiem, politykiem czy płatnym zabójcą - 
              ten podcast jest dla CIebie.
            </p>
            <p className="text-lg text-deep-charcoal dark:text-silver-mist mb-6">
              Docenisz konkretne, oparte na doświadczeniu strategie zamiast teoretycznych koncepcji. 
              Dlatego każdy odcinek skupia się na sprawdzonych rozwiązaniach, które można natychmiast 
              wdrożyć – idealny towarzysz podczas dojazdów do pracy czy na siłownię.
            </p>
            <p className="text-lg text-deep-charcoal dark:text-silver-mist">
              Jeśli zmagasz się z równoważeniem wysokich ambicji i potrzeby odpoczynku, ten podcast 
              dostarczy Ci narzędzi, które zoptymalizują Twój czas i energię bez ryzyka wypalenia.
            </p>
            ...
            <div className="mt-8 p-4 bg-luminous-white dark:bg-deep-space/80 rounded-lg border border-border">
              ...
              <p className="text-deep-charcoal dark:text-silver-mist">
                <strong>Nowe odcinki:</strong> Co czwartek – idealny moment na refleksję przed końcem tygodnia
              </p>
              <p className="text-deep-charcoal dark:text-silver-mist">
                <strong>Prowadzi:</strong> Ludwik C. Siadlak - life hacker, trener, mentor, absolwent Oksfordu i motocyklista w jednym
              </p>
            </div>
          </div>
      ...
      <section className="py-12 bg-secondary/30 dark:bg-quantum-blue/20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-deep-charcoal/80 dark:text-silver-mist/80 mb-6 max-w-2xl mx-auto">
            Dołącz do społeczności słuchaczy, którzy co tydzień otrzymują powiadomienia o nowych odcinkach
            i ekskluzywne materiały, które nie są publikowane nigdzie indziej.
          </p>
