...
const WebinarRegistration = () => {
  ...
  const onSubmit = (data: FormValues) => {
    ...
    toast({
      ...
      description:
        "Sprawdź swoją skrzynkę email, aby uzyskać szczegóły webinaru.",
    });
  ...
  const testimonials = [
    {
      quote:
        "Ludwik to rzadki przykład eksperta, który łączy głęboką wiedzę techniczną z prawdziwym zrozumieniem ludzkiego potencjału. Jego podejście odmieniło moje myślenie o karierze i technologii.",
      author: "Marcin K., CTO",
    },
    {
      quote:
        "Po wdrożeniu metodologii Black Panther, którą poznałem na webinarze Ludwika, moja produktywność wzrosła o 40%, a co ważniejsze, odzyskałem kontrolę nad tym, jak i kiedy korzystam z technologii.",
      author: "Anna W., Project Manager",
    },
    {
      quote:
        "Webinar był momentem zwrotnym w mojej karierze. Z analityka danych stałem się strategicznym doradcą, który teraz zarabia 3x więcej i pracuje 10 godzin tygodniowo mniej.",
  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row gap-8 items-center">
            <div className="w-full lg:w-3/5">
              <div className="inline-flex items-center px-3 py-1 rounded-full bg-white/30 dark:bg-white/30 backdrop-blur-sm border border-neural-violet/30 text-neural-violet mb-4">
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-6 text-ascension-pink dark:text-ascension-pink-light">
                Odkryj 3 kluczowe strategie, które pozwolą Ci stać się
                suwerennym liderem zamiast wymienialnym trybem w maszynie
              </h2>

              <p className="text-lg md:text-xl mb-8 text-deep-charcoal/80 dark:text-silver-mist/80">
                Bezpłatny masterclass z Ludwikiem C. Siadlakiem: Jak wykorzystać
                energię Czarnej Pantery, aby technologia służyła Tobie, a nie
                odwrotnie
              </p>

              <div className="flex items-center gap-3 mb-8 py-2 px-4 bg-white/40 dark:bg-deep-space/50 backdrop-blur-sm rounded-lg border border-gray-200 dark:border-gray-800">
                ...
                <span className="font-medium">
                  19:00-20:30 (czasu polskiego)
                </span>
                <span className="mx-2">|</span>
                <span className="text-sm font-bold text-neural-violet">
                  TYLKO TRANSMISJA NA ŻYWO
                </span>
              </div>
            ...
            <div className="w-full md:w-2/3">
              ...
              <ul className="space-y-2 mb-4">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    15+ lat doświadczenia jako certyfikowany trener Microsoft
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-neural-violet flex-shrink-0 mt-0.5" />
                  <span>
                    Mentor dla profesjonalistów poszukujących suwerenności
                    zawodowej
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-neural-violet flex-shrink-0 mt-0.5" />
                  <span>
                    Twórca metodologii "Black Panther" transformującej
                    specjalistów IT w liderów
                  </span>
                </li>
              </ul>
              ...
              <p className="text-lg">
                ...
                rozwoju ludzkiego potencjału. Moje podejście opiera się na
                konkretnych działaniach, które przynoszą rzeczywiste rezultaty.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* For Who Section */}
      <section className="py-16 bg-white/40 dark:bg-deep-space/40 backdrop-blur-sm">
      ...
      <section className="py-16 bg-gradient-to-r from-neural-violet/10 to-ascension-pink/10 dark:from-neural-violet/20 dark:to-ascension-pink/20">
        <div className="container max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">
            Pamiętaj: to nie jest typowy webinar o produktywności. To
            fundamentalna zmiana podejścia do swojej roli w świecie zdominowanym
            przez technologię.
          </p>
          <Button
            onClick={() =>
          ...
          <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
            Potwierdzenie i link do webinaru otrzymasz natychmiast po
            rejestracji
          </p>
        </div>
      </section>
