      ...
      <div className="min-h-screen bg-gradient-to-br from-luminous-white to-secondary dark:from-deep-space dark:to-neural-violet/30 pt-12 pb-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <h1 className="text-3xl md:text-4xl font-bold mb-2 text-neural-violet bg-gradient-to-r from-neural-violet to-ascension-pink bg-clip-text text-transparent">
              Witaj w Sali Webinarowej Black Panther
            </h1>
            <p className="text-xl mb-6 text-deep-charcoal/80 dark:text-silver-mist/90">
            ...
            <div className="space-y-8">
              <div className="bg-white dark:bg-deep-space/60 backdrop-blur-lg rounded-2xl p-8 border border-gray-200 dark:border-gray-800 shadow-lg">
                <h2 className="text-xl font-bold mb-4">
                  Podczas gdy czekasz, przygotuj się:
                </h2>
                ...
                <div className="space-y-4">
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <p className="mb-2">
                        Pobierz arkusz pracy webinaru – pomoże Ci
                        ustrukturyzować notatki i kluczowe insighty:
                      </p>
                      <Button
                        variant="outline"
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <p>
                        Podziel się swoim największym wyzwaniem w czacie –
                        poruszę najczęściej wymieniane problemy podczas webinaru
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <p className="mb-2">
                        Upewnij się, że Twoje audio działa prawidłowo – kliknij
                        przycisk testowy poniżej:
                      </p>
                      <Button
                        variant={audioTested ? "outline" : "default"}
                        className={
                          audioTested ? "border-green-500 text-green-500" : ""
                        }
                        onClick={handleAudioTest}
                      >
                        {audioTested ? (
                          <>
                            <CheckCircle className="mr-2 h-4 w-4" /> Audio
                            działa poprawnie
                          </>
                        ) : (
                          "Test Audio"
              ...
              <div className="bg-white dark:bg-deep-space/60 backdrop-blur-lg rounded-2xl p-8 border border-gray-200 dark:border-gray-800 shadow-lg">
                ...
                <ul className="list-disc list-inside space-y-2 mb-6">
                  ...
                  <li>
                    Jedno słowo opisujące, czego oczekujesz od dzisiejszego
                    webinaru
                  </li>
                </ul>
                ...
                <div className="p-4 bg-neural-violet/5 rounded-lg border border-neural-violet/20">
                  <p className="text-sm italic">
                    "Cześć wszystkim! Jestem Anna, pracuję jako frontend
                    developer. Od dzisiejszego webinaru oczekuję: inspiracji."
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white dark:bg-deep-space/60 backdrop-blur-lg rounded-2xl p-8 border border-gray-200 dark:border-gray-800 shadow-lg">
                ...
                <ul className="space-y-3 mb-6">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      Dla najlepszego doświadczenia zalecamy przeglądarkę Chrome
                      lub Firefox
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-neural-violet flex-shrink-0 mt-0.5" />
                    <span>
                      Jeśli napotkasz problemy, odśwież stronę lub użyj
                      przycisku pomocy
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-gradient-to-r from-neural-violet/20 to-ascension-pink/20 dark:from-neural-violet/30 dark:to-ascension-pink/30 backdrop-blur-lg rounded-2xl p-8 border border-neural-violet/30 dark:border-neural-violet/40 shadow-lg">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-xl font-bold">
                    Ekskluzywna sesja Q&A dla wcześnie dołączających!
                  </h2>
                </div>

                <p className="mb-6">
                  Sesja Q&A rozpocznie się o 18:50! Ludwik odpowie na wybrane
                  pytania uczestników, którzy dołączą przed oficjalnym
                  rozpoczęciem webinaru. To Twoja szansa na bezpośrednią
                  interakcję.
                </p>
                ...
                <p className="text-sm text-center mt-4">
                  Webinar rozpocznie się automatycznie, gdy odliczanie dobiegnie
                  końca
                </p>
              </div>
            </div>
