...
import { OTOProductDisplayV2 } from '@/components/oto/OTOProductDisplayV2';
...
function OTOContentV2() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Trwa sprawdzanie dostępności...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="relative">
      <OTOProductDisplayV2 onExpired={handleExpired} />
    </div>
  );
}

export default function OTOv2() {
  return (
    <ReferrerGuard>
      <OTOContentV2 />
    </ReferrerGuard>
