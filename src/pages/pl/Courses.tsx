...
const coursesData = [
  {
    ...
    subtitle: 'Premium 8-tygodniowy program mentoringowy',
    description: 'Intensywny program mentoringowy dla profesjonalistów gotowych przejąć pełną kontrolę nad swoją karierą i życiem cyfrowym.',
    features: [
      'Cotygodniowe sesje 1:1',
      'Spersonalizowany system produktywności',
      'Zestaw modeli mentalnych',
      'Dożywotni dostęp do materiałów',
      'Dostęp do prywatnej społeczności'
    ],
    duration: '8 tygodni',
    format: 'Hybrydowy (Online + Sesje na żywo)',
    level: 'Średniozaawansowany do Zaawansowanego',
    startDate: 'Elastyczne daty rozpoczęcia',
    featured: true,
    image: ''
  },
  {
    ...
    subtitle: 'Program mistrzostwa produktywności',
    description: 'Kompleksowy kurs online, który przekształca Twoje podejście do produktywności, łącząc narzędzia technologiczne z głębokim zrozumieniem ludzkich potrzeb.',
    features: [
      'Personalizowana ocena produktywności',
      'Własny system zarządzania zadaniami',
      'Protokoły skupienia i głębokiej pracy',
      'Zarządzanie energią i uwagą',
      'Plan integracji technologii'
    ],
    duration: '6 tygodni',
    format: 'Online we własnym tempie + Rozmowy grupowe',
    level: 'Wszystkie poziomy',
    startDate: 'Zapisy otwierają się kwartalnie',
    featured: false,
    image: ''
  },
  {
    ...
    subtitle: 'Dla liderów i managerów technicznych',
    description: 'Rozwiń unikalne umiejętności wymagane do skutecznego przewodzenia zespołom technicznym przy jednoczesnym nawigowaniu szybko zmieniającymi się krajobrazami technologicznymi.',
    features: [
      'Ramy przywództwa technicznego',
      'Protokoły komunikacji zespołowej',
      'Podejmowanie decyzji w niepewności',
      'Zarządzanie długiem technologicznym',
      'Planowanie strategiczne dla zespołów technicznych'
    ],
    duration: '10 tygodni',
    format: 'Kurs kohortowy online',
    level: 'Zaawansowany',
    startDate: 'Następna kohorta: wrzesień 2025',
    featured: false,
    image: ''
  }
];
