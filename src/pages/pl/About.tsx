...
const PolishAbout = () => {
  ...
  const credentials = [
    "Ponad 15 lat jako certyfikowany trener Microsoft",
    "Szkolenia zespołów w firmach z listy Fortune 500 i organizacjach wojskowych",
    "Twórca społeczności Hackerzy z ponad 1500 aktywnymi członkami",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              <div className="prose prose-lg dark:prose-invert max-w-none">
                <p>
                  Od ponad 15 lat działam na styku najnowocześniejszej technologii i ludzkiej wydajności. Dzięki wiedzy z obu światów, prowadzę profesjonalistów do odzyskania kontroli nad ich cyfrowym życiem bez poświęcania tego, co czyni ich wyjątkowo ludzkimi.
                </p>
                
                <p>
                  Moja podróż rozpoczęła się jako certyfikowany trener Microsoft, gdzie na własne oczy zobaczyłem, jak technologia może albo wzmacniać, albo przytłaczać. Podczas gdy inni koncentrowali się wyłącznie na umiejętnościach technicznych, ja dostrzegłem, że brakującym elementem jest nauczenie ludzi, jak zachować ludzką przewagę przy jednoczesnym wykorzystaniu cyfrowych narzędzi.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg mb-8 text-white/90">
              Zacznij od moich cotygodniowych inspiracji lub umów Rozmowę Odkrywczą.
            </p>
