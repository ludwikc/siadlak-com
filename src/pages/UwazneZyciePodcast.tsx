...
const UwazneZyciePodcast = () => {
  ...
  const episodes: PodcastEpisode[] = [
    {
      ...
      description: 'W tym odcinku omawiam prostą, ale niezwykle skuteczną technikę oddechową, którą możesz zastosować w dowolnym momencie dnia, aby szybko zresetować swój układ nerwowy. Idealny sposób na powrót do równowagi po stresującej sytuacji.',
      date: '2 maja 2025',
      duration: '23 min',
      audioUrl: '#',
    ...
    },
    {
      ...
      description: 'Zaledwie 9 minut porannej praktyki może radykalnie zmienić przebieg całego dnia. W tym odcinku prezentuję krok po kroku prowadzoną medytację, którą możesz wykonać zaraz po przebudzeniu.',
    ...
    },
    {
      ...
      description: 'Problemy ze snem dotykają coraz więcej profesjonalistów. W tym odcinku prowadzę Cię przez medytację skanowania ciała, która pomaga wyciszyć umysł i przygotować się do głębokiego, regenerującego snu.',
  ...
  const platforms = [
    ...
    { name: 'Apple Podcasts', url: 'https://apple.com/apple-podcasts', icon: 'https://upload.wikimedia.org/wikipedia/commons/e/e7/Podcasts_%28iOS%29.svg' },
    { name: 'Google Podcasts', url: 'https://podcasts.google.com', icon: 'https://upload.wikimedia.org/wikipedia/commons/4/42/Google_Podcasts_icon.svg' },
    { name: 'YouTube', url: 'https://youtube.com', icon: 'https://upload.wikimedia.org/wikipedia/commons/7/72/YouTube_social_white_square_%282017%29.svg' }
  ];
  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto mb-12">
            <p className="text-lg text-deep-charcoal dark:text-silver-mist mb-6">
              W świecie, gdzie produktywność jest często stawiana ponad dobrostanem, "Uważne Życie" 
              oferuje przestrzeń na odzyskanie równowagi bez poczucia winy.
            </p>
            <p className="text-lg text-deep-charcoal dark:text-silver-mist mb-6">
              Każdy odcinek zawiera praktyczne ćwiczenia uważności, które możesz wykonać podczas 
              porannej kawy, w drodze do pracy, czy wieczorem po intensywnym dniu. To nie teoretyczne 
              dywagacje, ale konkretne techniki dla ludzi, którzy cenią skuteczność nawet w pracy nad sobą.
            </p>
            <p className="text-lg text-deep-charcoal dark:text-silver-mist">
              Regularna praktyka uważności poprawi Twoją zdolność podejmowania decyzji, odporność na stres 
              i jakość koncentracji – kluczowe umiejętności dla ambitnych profesjonalistów na każdym poziomie kariery.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-luminous-white dark:bg-deep-space/80 rounded-lg border border-border p-6">
            ...
            <p className="text-deep-charcoal dark:text-silver-mist mb-6">
              Dołącz do cotygodniowej sesji medytacji na żywo - to wyjątkowa okazja, by praktykować 
              uważność w grupie podobnie myślących profesjonalistów. Sesje odbywają się każdy wtorek 
              o 6:30 rano – idealny moment na reset na resztę tygodnia, po ugaszeniu poniedziałkowych 
              pożarów.
            </p>
            ...
            <div className="bg-secondary/50 dark:bg-quantum-blue/30 p-4 rounded-md mb-6">
              ...
              <p className="text-deep-charcoal dark:text-silver-mist">
                <strong>Temat:</strong> Technika "Mental Elevator" - medytacja dla zwiększenia świadomości swojej wartości
              </p>
            </div>
            ...
            <form className="mb-4">
              ...
              <p className="text-sm text-subtle-slate dark:text-gentle-lavender mt-2">
                Otrzymasz przypomnienie na 30 minut przed każdą sesją oraz dostęp do nagrań.
              </p>
            </form>
      ...
      <section id="episodes" className="py-12 bg-secondary/30 dark:bg-quantum-blue/20">
        <div className="container mx-auto px-4">
