...
import { MessageSquare, HelpCircle, Download, ExternalLink } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="md:col-span-3 space-y-6">
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
                <Tabs defaultValue="chat">
                  ...
                  <TabsContent value="chat" className="h-64 overflow-y-auto p-4 bg-white/5 rounded-lg">
                    <div className="space-y-4">
                      <div className="flex gap-3">
                        ...
                        <div>
                          <p className="font-medium text-white">Ludwik C. Siadlak</p>
                          <p className="text-gray-300">Witam wszystkich na dzisiejszym webinarze! Zaczynamy za chwilę.</p>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-3">
                        ...
                        <div>
                          <p className="font-medium text-white">Anna Kowalska</p>
                          <p className="text-gray-300">Bardzo się cieszę, że mogę uczestniczyć! Pozdrawiam z Krakowa.</p>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-300">Czekam z niecierpliwością na omówienie metodologii Black Panther!</p>
                        </div>
                      </div>
                    </div>
                  </TabsContent>
                  
                  <TabsContent value="polls" className="h-64 overflow-y-auto p-4 bg-white/5 rounded-lg">
                    <div className="text-center text-white p-4">
                      <p className="mb-4">Aktywna ankieta:</p>
                      <p className="font-medium mb-6">Które wyzwanie jest dla Ciebie największe?</p>
                  ...
                  <TabsContent value="questions" className="h-64 overflow-y-auto p-4 bg-white/5 rounded-lg">
              ...
              {showOffer && (
                <div className="bg-gradient-to-r from-neural-violet/30 to-ascension-pink/30 backdrop-blur-lg rounded-xl p-6 border border-neural-violet/30 animate-fade-in">
                  ...
                  <p className="text-gray-300 mb-6">
                    Teraz możesz dowiedzieć się więcej o pełnym programie transformacji, 
                    który przeprowadzi Cię z reaktywnego wykonawcy do suwerennego lidera.
                  </p>
                  <Button 
                    size="lg"
                  ...
                  <p className="text-sm text-center text-gray-400 mt-2">
                    Kliknij, aby zobaczyć szczegóły - nie przegapisz żadnej części webinaru
                  </p>
                </div>
              )}
            ...
            <div className="space-y-6">
              {/* Resources Panel */}
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
                <h3 className="text-lg font-bold text-white mb-4">Materiały pomocnicze:</h3>
                ...
                <div className="space-y-3">
                  ...
                  >
                    <Download className="mr-2 h-4 w-4" /> Prezentacja (po webinarze)
                  </Button>
              ...
              {/* Notes Panel */}
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
                <h3 className="text-lg font-bold text-white mb-4">Twoje notatki:</h3>
