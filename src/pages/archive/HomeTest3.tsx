...
function DiamondDivider() {
  return (
    <div className="flex items-center justify-center gap-4 py-16">
      <div className="h-px w-16 bg-gradient-to-r from-transparent to-[hsl(var(--text-on-dark-secondary))]/30" />
      <Diamond size={14} className="text-[hsl(var(--text-on-dark-secondary))]/40" />
      <div className="h-px w-16 bg-gradient-to-l from-transparent to-[hsl(var(--text-on-dark-secondary))]/30" />
    </div>
  );
}
...
function CTA({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <Link to={DISCOVERY_LINK}>
      ...
      >
        <span className="absolute inset-0 rounded-full bg-gradient-to-r from-[hsl(var(--void-black))] via-[hsl(var(--depth-purple-dark))] to-[hsl(var(--void-black))] opacity-90 group-hover:opacity-100 transition-opacity" />
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <span className="inline-block text-[11px] font-semibold tracking-[0.3em] uppercase text-[hsl(var(--text-on-dark-tertiary))] mb-8">
      {children}
    </span>
  );
}
...
export default function HomeTest3() {
  return (
    <>
      ...
      <div className="min-h-screen bg-[hsl(var(--diamond-light))] text-[hsl(var(--depth-purple-dark))] antialiased selection:bg-[hsl(var(--text-on-dark-secondary))]/20 selection:text-[hsl(var(--void-black))]">
        ...
        <section className="relative min-h-screen flex items-center overflow-hidden">
          ...
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute top-[-20%] left-[-10%] w-[60vw] h-[60vw] rounded-full bg-[hsl(var(--text-on-dark))]/40 blur-[120px]" />
            <div className="absolute bottom-[-10%] right-[-5%] w-[50vw] h-[50vw] rounded-full bg-[hsl(var(--text-on-dark))]/30 blur-[100px]" />
            <div className="absolute top-[30%] right-[20%] w-[30vw] h-[30vw] rounded-full bg-[hsl(var(--diamond-light))]/30 blur-[80px]" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="order-2 lg:order-1 max-w-2xl">
                <div className="flex items-center gap-2 mb-10">
                  <Diamond size={16} className="text-[hsl(var(--text-on-dark-secondary))]" />
                  <span className="text-[11px] font-semibold tracking-[0.35em] uppercase text-[hsl(var(--text-on-dark-tertiary))]">
                    Diamentowy Umysł
                  </span>
                </div>

                <h1 className="text-[2.5rem] md:text-[3.2rem] lg:text-[3.8rem] leading-[1.15] font-light text-[hsl(var(--void-black))] mb-10 tracking-tight">
                  Diament jest najtwardszą{" "}
                  <br className="hidden md:block" />
                  substancją na Ziemi.
                  <span className="block mt-2 text-[hsl(var(--text-on-dark-tertiary))]">
                    I jest kompletnie przezroczysty.
                  </span>
                </h1>

                <div className="space-y-5 text-lg md:text-xl leading-relaxed text-[hsl(var(--text-on-dark-tertiary))] max-w-xl">
                  <p>
                    Połóż go na czerwonym suknie – wygląda jak rubin.
                    Na zielonym – jak szmaragd.
                  </p>
                  <p>Zmień sukno – zmieni się „kolor" diamentu.</p>
                  <p className="text-[hsl(var(--depth-purple-dark))]">
                    Ale diament sam w sobie? Nie ma koloru. Jest czysty.
                  </p>
                  <p className="text-[hsl(var(--depth-purple-dark))] font-medium">
                    Twój umysł działa dokładnie tak samo.
                  </p>
                </div>

                <div className="mt-12 space-y-4 text-[hsl(var(--text-on-dark-tertiary))] text-base md:text-lg leading-relaxed max-w-xl">
                  <p>
                    Otaczasz się presją – nabiera koloru napięcia.{" "}
                    <span className="text-[hsl(var(--text-on-dark-secondary))]">Myślisz: „jestem zestresowany".</span>
                  </p>
                  <p>
                    Wchodzisz w sprint za celem – nabiera koloru głodu.{" "}
                    <span className="text-[hsl(var(--text-on-dark-secondary))]">Myślisz: „nigdy nie mam dość".</span>
                  </p>
                  <p>
                    Wracasz po 14 godzinach – nabiera koloru pustki.{" "}
                    <span className="text-[hsl(var(--text-on-dark-secondary))]">Myślisz: „coś jest ze mną nie tak".</span>
                  </p>
                </div>

                <div className="mt-12 space-y-4 text-lg md:text-xl text-[hsl(var(--depth-purple-dark))] max-w-xl">
                  <p>Ale to nie Ty się zmieniłeś. <span className="text-[hsl(var(--void-black))] font-medium">To sukno się zmieniło.</span></p>
                  <p className="text-[hsl(var(--void-black))] font-medium">Diament jest ten sam. Był, jest i będzie.</p>
                </div>

                <div className="mt-14 space-y-3 text-lg text-[hsl(var(--depth-purple-dark))]">
                  <p>
                    Nazywam się{" "}
                    <span className="text-[hsl(var(--void-black))] font-medium">Ludwik&nbsp;C.&nbsp;Siadlak</span>.
                  </p>
                  <p className="text-[hsl(var(--text-on-dark-tertiary))]">Nie szlifuję ludzi. Nie zmieniam ich.</p>
                  <p className="text-[hsl(var(--void-black))]">
              ...
              <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
                <div className="relative">
                  ...
                  <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-32 h-32 border border-[hsl(var(--text-on-dark-secondary))]/15 rotate-45 rounded-sm" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="relative py-24 md:py-32">
          <div className="absolute inset-0 bg-gradient-to-b from-[hsl(var(--diamond-light))] via-[hsl(var(--diamond-light))] to-[hsl(var(--diamond-light))]" />
          <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-3xl">
            <SectionLabel>Problem</SectionLabel>

            <h2 className="text-3xl md:text-4xl lg:text-5xl font-light text-[hsl(var(--void-black))] mb-6 leading-tight">
              Przez lata próbowałeś zmienić diament.
            </h2>
            <p className="text-xl md:text-2xl text-[hsl(var(--text-on-dark-tertiary))] mb-16">
              Nie wiedziałeś, że wystarczyło zmienić sukno.
            </p>

            <div className="space-y-5 text-lg leading-relaxed text-[hsl(var(--text-on-dark-tertiary))]">
              ...
              <p>
                ...
                <span className="text-[hsl(var(--depth-purple-dark))]">A potem ten znajomy moment:</span>
              </p>
              <p className="text-[hsl(var(--depth-purple-dark))] italic pl-4 border-l-2 border-[hsl(var(--text-on-dark-secondary))]/40">
              ...
              <p className="text-[hsl(var(--void-black))] text-xl mt-8">
                On potrzebuje kogoś, kto powie:
                <br />
                <span className="italic text-[hsl(var(--text-on-dark-tertiary))]">„Zdejmij sukno i&nbsp;spójrz".</span>
              </p>
              <p className="mt-8 text-[hsl(var(--text-on-dark-tertiary))]">
        ...
        <section className="relative py-24 md:py-32">
          ...
          <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-3xl">
            ...
            <h2 className="text-3xl md:text-4xl font-light text-[hsl(var(--void-black))] mb-16 leading-tight">
              Nie liczby. Przełom.
            </h2>
            ...
            <div className="space-y-5 text-lg leading-relaxed text-[hsl(var(--text-on-dark-tertiary))]">
              ...
              <p>
                Mógłbym. <span className="text-[hsl(var(--depth-purple-dark))]">Ale to nie to przekonuje ludzi, z&nbsp;którymi pracuję.</span>
              </p>
              <p className="text-[hsl(var(--depth-purple-dark))]">
              ...
              <div className="my-10 pl-5 border-l-2 border-[hsl(var(--text-on-dark-secondary))]/40 space-y-4">
                <p className="text-[hsl(var(--depth-purple-dark))]">
                ...
                <p className="text-[hsl(var(--depth-purple-dark))]">I kompletną pustkę w&nbsp;środku.</p>
              </div>

              <p className="text-[hsl(var(--depth-purple-dark))]">
                Tamtego dnia zrozumiałem coś, co potem zmieniło życie setek ludzi:
              </p>
              <p className="text-[hsl(var(--void-black))] text-xl font-medium">
                żeby zmienić grę, musiałem zobaczyć, że nie jestem graczem.
              </p>
              <p className="text-[hsl(var(--void-black))]">Jestem tym, kto patrzy.</p>
              <p className="text-[hsl(var(--text-on-dark-tertiary))]">
                Nie diamentem. Nie kolorem sukna.
                <br />Obserwatorem, który może <em className="text-[hsl(var(--depth-purple-dark))]">wybrać</em> – na czym ten diament położyć.
              </p>
        ...
        <section className="relative py-24 md:py-32">
          ...
          <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-3xl">
            ...
            <h2 className="text-3xl md:text-4xl font-light text-[hsl(var(--void-black))] mb-4 leading-tight">
              Diamentowy Umysł.
            </h2>
            <p className="text-xl text-[hsl(var(--text-on-dark-tertiary))] mb-16">Nie metafora – metoda.</p>
            ...
            <div className="space-y-5 text-lg leading-relaxed text-[hsl(var(--text-on-dark-tertiary))]">
              ...
              <p className="text-[hsl(var(--depth-purple-dark))]">Metafora działa tam, gdzie logika się zatrzymuje.</p>
              <p>
            ...
            {/* inline testimonial */}
            <div className="mt-14 p-8 rounded-2xl bg-white border border-[hsl(var(--text-on-dark))] shadow-sm">
              <p className="text-[hsl(var(--text-on-dark-tertiary))] text-sm mb-4 tracking-wide uppercase font-medium">
                Łukasz — informatyk, ADHD, sceptyk
              </p>
              <blockquote className="text-[hsl(var(--depth-purple-dark))] text-lg leading-relaxed italic">
                „Jestem w szoku. Mam totalną pustkę w głowie. Jak rzadko.
                Nie do końca wiem, co się wydarzyło... I&nbsp;chcę więcej."
              </blockquote>
              <p className="text-[hsl(var(--text-on-dark-secondary))] text-base mt-4">
                Nie uczył się medytacji. Rozmawialiśmy o&nbsp;samochodach.
                <br />A on zobaczył swój diament.
              </p>
            </div>

            <div className="mt-10 space-y-3 text-lg text-[hsl(var(--text-on-dark-tertiary))]">
              <p className="text-[hsl(var(--depth-purple-dark))]">To nie jest coaching, który widziałeś u&nbsp;innych.</p>
              <p>To praca na poziomie systemu operacyjnego.</p>
              <p className="text-[hsl(var(--depth-purple-dark))]">Prowadzona z&nbsp;troską. Ale bez anestezji.</p>
            </div>
          </div>
        </section>
        ...
        <section className="relative py-24 md:py-32">
          ...
          <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-3xl">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[hsl(var(--text-on-dark-secondary))]/30 to-[hsl(var(--text-on-dark-secondary))]/10 flex items-center justify-center">
                <Sparkles size={18} className="text-[hsl(var(--text-on-dark-tertiary))]" />
              </div>
              <h2 className="text-3xl md:text-4xl font-light text-[hsl(var(--void-black))]">
                Life OS: System Upgrade
              </h2>
            </div>

            <p className="text-xl text-[hsl(var(--text-on-dark-tertiary))] mb-10">
              8 tygodni. Maksymalnie 5 osób. Pełne zobaczenie diamentu pod suknem.
            </p>

            <div className="space-y-5 text-lg leading-relaxed text-[hsl(var(--text-on-dark-tertiary))] mb-14">
              <p>
              ...
              <p>
                ...
                <span className="text-[hsl(var(--void-black))]"> Czyste. Twarde. Przezroczyste. Twoje.</span>
              </p>
              <p>
            ...
            {/* value items */}
            <h3 className="text-sm tracking-[0.2em] uppercase text-[hsl(var(--text-on-dark-tertiary))] font-semibold mb-8">Co dostajesz</h3>
            <div className="space-y-6 mb-14">
              {[
                ...
                <div key={i} className="flex items-start gap-4 group">
                  <div className="mt-1.5 w-5 h-5 rounded-full border border-[hsl(var(--text-on-dark-secondary))]/40 flex items-center justify-center flex-shrink-0">
                    <Diamond size={10} className="text-[hsl(var(--text-on-dark-secondary))]/70" />
                  </div>
                  <div className="flex-1">
                    <p className="text-[hsl(var(--depth-purple-dark))] text-base leading-relaxed">{item.text}</p>
                    <p className="text-[hsl(var(--text-on-dark-secondary))] text-sm mt-1">{item.value}</p>
                  </div>
                </div>
              ))}
            </div>

            <div className="p-6 rounded-xl bg-white border border-[hsl(var(--text-on-dark))] shadow-sm mb-10">
              <p className="text-[hsl(var(--text-on-dark-tertiary))] text-base mb-1">Łączna wartość</p>
              <p className="text-[hsl(var(--void-black))] text-3xl font-light">39 000 PLN</p>
            </div>

            <p className="text-[hsl(var(--text-on-dark-tertiary))] text-lg mb-10">
        ...
        <section className="relative py-24 md:py-32">
          ...
          <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-3xl">
            ...
            <h2 className="text-3xl md:text-4xl font-light text-[hsl(var(--void-black))] mb-6 leading-tight">
              Nie powiem Ci, że jestem dobry.
            </h2>
            <p className="text-xl text-[hsl(var(--text-on-dark-tertiary))] mb-16">
            ...
            <div className="space-y-10">
              {[
                ...
                <div
                  key={i}
                  className="p-8 rounded-2xl bg-white border border-[hsl(var(--text-on-dark))] shadow-sm"
                >
                  <p className="text-[hsl(var(--text-on-dark-tertiary))] text-sm font-semibold tracking-wide mb-1">{t.name}</p>
                  <p className="text-[hsl(var(--text-on-dark-secondary))] text-sm mb-5">{t.label}</p>
                  <blockquote className="text-[hsl(var(--depth-purple-dark))] text-lg leading-relaxed italic">
                    „{t.quote}"
                  </blockquote>
                </div>
        ...
        <section className="relative py-24 md:py-32">
          ...
          <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-3xl">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* not for you */}
              <div className="p-8 rounded-2xl bg-[hsl(var(--diamond-light))] border border-[hsl(var(--text-on-dark))]">
                <p className="text-[hsl(var(--text-on-dark-secondary))] text-sm font-semibold tracking-wide uppercase mb-6">To nie dla Ciebie, jeśli</p>
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-[hsl(var(--text-on-dark-tertiary))]">
                      <X size={16} className="text-[hsl(var(--text-on-dark-secondary))] mt-1 flex-shrink-0" />
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
              ...
              {/* for you */}
              <div className="p-8 rounded-2xl bg-white border border-[hsl(var(--text-on-dark-secondary))]/25 shadow-sm">
                <p className="text-[hsl(var(--text-on-dark-tertiary))] text-sm font-semibold tracking-wide uppercase mb-6">To jest dla Ciebie, jeśli</p>
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-[hsl(var(--depth-purple-dark))]">
                      <Check size={16} className="text-[hsl(var(--text-on-dark-tertiary))] mt-1 flex-shrink-0" />
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
        ...
        <section className="relative py-24 md:py-32">
          ...
          <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-3xl">
            ...
            <h2 className="text-3xl md:text-4xl font-light text-[hsl(var(--void-black))] mb-10 leading-tight">
              Moja obietnica jest prosta.
            </h2>

            <div className="p-8 md:p-10 rounded-2xl bg-white border border-[hsl(var(--text-on-dark-secondary))]/20 shadow-sm space-y-5 text-lg text-[hsl(var(--depth-purple-dark))] leading-relaxed">
              <p>
              ...
              <p className="text-[hsl(var(--void-black))] font-medium">Nie zapłacisz ani złotówki więcej.</p>
              <p className="text-[hsl(var(--text-on-dark-tertiary))]">
                Mogę to zaoferować, bo wiem, co dostarczam.
                <br />Nie godziny. Nie porady.
              </p>
              <p className="text-[hsl(var(--text-on-dark-tertiary))] italic">
        ...
        <section className="relative py-24 md:py-32">
          <div className="absolute inset-0 bg-gradient-to-b from-[hsl(var(--diamond-light))] via-[hsl(var(--diamond-light))] to-[hsl(var(--diamond-light))]" />
          {/* subtle warm glow */}
          <div className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[50vw] h-[30vh] rounded-full bg-[hsl(var(--text-on-dark))]/30 blur-[100px]" />

          <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-3xl text-center">
            <p className="text-[hsl(var(--text-on-dark-tertiary))] text-lg mb-6">
              Mam miejsce dla maksymalnie <span className="text-[hsl(var(--void-black))] font-medium">5 osób</span> jednocześnie.
            </p>
            ...
            <p className="text-[hsl(var(--depth-purple-dark))] text-lg mb-4">
              Jeśli to, co przeczytałeś, wywołało w&nbsp;Tobie jakiekolwiek poruszenie – to dobry znak.
            </p>
            <p className="text-[hsl(var(--void-black))] text-xl mb-10">
              Nie potrzebujesz więcej tekstu. Potrzebujesz rozmowy.
            </p>
            <p className="text-[hsl(var(--text-on-dark-secondary))] text-sm mb-10">
        ...
        <section className="relative py-20">
          <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-3xl">
            <div className="space-y-4 text-lg text-[hsl(var(--text-on-dark-tertiary))] leading-relaxed">
              <p className="text-[hsl(var(--depth-purple-dark))] text-xl">Jeszcze nie teraz? Rozumiem.</p>
              <p>
              ...
              <p className="text-[hsl(var(--depth-purple-dark))]">Mam na to coś.</p>
            </div>
          </div>
        </section>
        ...
        <section className="relative py-24 md:py-32">
          ...
          <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-3xl">
            ...
            <div className="flex items-center gap-3 mb-4">
              <Brain size={22} className="text-[hsl(var(--text-on-dark-tertiary))]" />
              <h2 className="text-3xl md:text-4xl font-light text-[hsl(var(--void-black))]">
                Aplikacje Mentalne
              </h2>
            </div>
            <p className="text-xl text-[hsl(var(--text-on-dark-tertiary))] mb-6">
              Konkretne narzędzia na konkretne problemy.
            </p>
            <p className="text-[hsl(var(--text-on-dark-tertiary))] text-lg mb-14 leading-relaxed">
            ...
            <div className="space-y-8">
              {[
                ...
                <div
                  key={i}
                  className="p-6 md:p-8 rounded-2xl bg-white border border-[hsl(var(--text-on-dark))] shadow-sm hover:border-[hsl(var(--text-on-dark-secondary))]/30 transition-colors"
                >
                  <div className="flex items-center gap-3 mb-4">
                    <span className="text-[hsl(var(--text-on-dark-tertiary))]">{app.icon}</span>
                    <h3 className="text-xl font-medium text-[hsl(var(--void-black))]">{app.title}</h3>
                  </div>
                  <p className="text-[hsl(var(--text-on-dark-tertiary))] leading-relaxed">{app.desc}</p>
                </div>
              ))}
            </div>

            <p className="text-[hsl(var(--text-on-dark-tertiary))] text-base mt-10 leading-relaxed">
            ...
            <div className="mt-10">
              <Link
                to={PROGRAM_LINK}
                className="inline-flex items-center gap-2 text-[hsl(var(--text-on-dark-tertiary))] hover:text-[hsl(var(--void-black))] transition-colors text-base font-medium"
              >
        ...
        <section className="relative py-24 md:py-32">
          <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-3xl text-center">
            <p className="text-[hsl(var(--depth-purple-dark))] text-xl mb-2">Diamentowy umysł. Otwarta przyłbica.</p>
            <p className="text-[hsl(var(--text-on-dark-secondary))] text-base">— Ludwik C. Siadlak</p>
          </div>
        </section>
