      ...
      <section className="bg-void-glow py-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="bg-surface border border-white/10 rounded-md p-6 md:p-8 mt-8">
            ...
            >
              Dołącz do SIADLAK.VIP na Telegramie</a>
          </div>
        </div>
      </section>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-electric text-sm font-bold hover:underline"
                  >
                    Dołącz do sesji na DeepWork.pl</a>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-electric text-sm font-bold hover:underline"
                  >
                    Zacznij medytować na UwazneZycie.pl</a>
                </div>
              </div>
            </div>
          </div>
