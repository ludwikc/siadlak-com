          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="w-full md:w-1/2">
              <h2 className="text-2xl md:text-3xl font-bold mb-6">
                Odkryj swoją Energię Czarnej Pantery
              </h2>

              <p className="text-lg mb-6">
                Ten szybki test odsłoni unikalny wzorzec równoważenia ambicji,
                odpowiedzialności i regeneracji. Zarówno osoby zarządzające
                kodem, projektami czy ludźmi – jak i te balansujące wielość ról
                dom-praca – odkryją, gdzie naprawdę tracą siłę oraz jak
                wprowadzić mikrokorekty, by codziennie działać z lekkością i
                klarownością.
              </p>

              <div className="mb-8">
                <h3 className="font-semibold text-xl mb-4">
                  Co otrzymasz po ukończeniu testu:
                </h3>
                        ...
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0 mt-4">
                          ...
                          <div className="space-y-1 leading-none">
                            <FormLabel className="text-sm font-normal">
                              Wyrażam dobrowolną zgodę na przetwarzanie mojego
                              imienia i adresu e-mail przez SIADLAK Holding
                              Group sp. z o.o. w Warszawie w celu przesłania
                              wyniku testu, materiałów uzupełniających oraz
                              uzyskania bezpłatnego dostępu do newslettera.
                              Zgodę mogę cofnąć w dowolnym momencie. Szczegóły w
      ...
      <section className="py-16 bg-gradient-to-r from-neural-violet/10 to-ascension-pink/10 dark:from-neural-violet/20 dark:to-ascension-pink/20">
        <div className="container max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">
            Nie możesz zmienić tego, czego nie rozumiesz. Ten test to pierwszy
            krok w Twojej podróży ku odkryciu pełnego potencjału metodologii
            Black Panther w Twoim życiu zawodowym.
          </p>
          <Button
            onClick={() =>
              document
