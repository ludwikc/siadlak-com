...
export default function TrainTheTrainer() {
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-deep-charcoal/80 font-medium">Wymaga kwalifikacji</span>
            </div>
            <div className="w-1 h-4 bg-gold/30"></div>
            <div className="flex items-center gap-2">
              <Shield className="w-4 h-4 text-gold" />
              <span className="text-deep-charcoal/80 font-medium">8 miejsc rocznie</span>
            </div>
            <div className="w-1 h-4 bg-gold/30"></div>
            <div className="flex items-center gap-2">
              <Star className="w-4 h-4 text-gold" />
              <span className="text-deep-charcoal/80 font-medium">Inwestycja premium</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl md:text-2xl mb-6 text-white/90 leading-relaxed">
                Prawdziwa wartość twojej wiedzy (nawet, jeśli to najsuchszy temat – jak konfiguracja SQL,
              ...
              <div className="flex flex-wrap gap-6 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/80">8 tygodni intensywnej pracy</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="mt-6 bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                <div className="text-gold font-semibold mb-2">US Department of Defense</div>
      ...
      <section className="relative py-20 bg-gradient-to-b from-white via-gold/5 to-white overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-10 w-40 h-40 bg-gold rounded-full blur-3xl animate-pulse"></div>
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 w-56 h-56 bg-gold/50 rounded-full blur-3xl animate-pulse delay-500"></div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-deep-charcoal">
                Kwalifikujesz się, <span className="text-gold">jeśli...</span>
              </h2>
              <div className="w-24 h-1.5 bg-gradient-to-r from-gold to-luminal-magenta rounded-full mx-auto mb-4"></div>
              <p className="text-lg text-deep-charcoal/70 max-w-2xl mx-auto">
                Ten program jest dla ekspertów gotowych na transformację w globalnych trenerów premium
              </p>
            </div>

            <div className="space-y-6">
              {[
                { text: "Masz minimum 5 lat doświadczenia w branży IT i specjalizujesz się w konkretnej dziedzinie technicznej", icon: Crown },
                { text: "Prowadzisz lub prowadziłeś projekty o wartości minimum $100K i rozumiesz kontekst biznesowy technologii", icon: Shield },
                { text: "Chcesz dzielić się wiedzą na międzynarodowych scenach i zarabiać $5K-15K za dzień szkolenia", icon: Star },
                { text: "Jesteś gotowy na 8 tygodni intensywnej pracy nad sobą i swoimi umiejętnościami prezenterskimi", icon: Crown },
                { text: "Szukasz mentora, który sam prowadzi szkolenia dla Fortune 500, rządów i armii od 19 lat", icon: Shield }
              ].map((item, index) => (
                <div key={index} className="group relative bg-gradient-to-br from-white via-gold/5 to-white rounded-2xl p-8 border-2 border-gold/20 hover:border-gold/50 shadow-lg hover:shadow-2xl hover:shadow-gold/20 transition-all duration-300 hover:-translate-y-2">
            ...
            <div className="mt-12 text-center">
              <div className="inline-block bg-gradient-to-r from-gold/10 via-luminal-magenta/10 to-gold/10 rounded-2xl p-8 border-2 border-gold/30">
                ...
                <a href="https://link.siadlak.com/discovery" target="_blank" rel="noopener noreferrer">
                  <div className="relative inline-block group">
                    <div className="absolute -inset-1 bg-gradient-to-r from-gold via-luminal-magenta to-gold rounded-xl blur-md opacity-50 group-hover:opacity-100 transition duration-300"></div>
                    <button className="relative bg-gradient-to-r from-gold to-luminal-magenta text-white px-10 py-4 rounded-xl text-lg font-bold shadow-xl flex items-center gap-3 transition-all hover:scale-105">
                      Umów Sesję Discovery
                      <ArrowRight size={20} />
                    </button>
                  </div>
      ...
      <section className="relative py-20 bg-gradient-to-br from-background to-deep-space/5 overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-20 left-10 w-48 h-48 bg-gold rounded-full blur-3xl animate-pulse"></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <Badge className="mb-6 px-6 py-3 bg-gradient-to-r from-neural-violet to-luminal-magenta text-white border-0 rounded-full text-sm font-semibold">
                Program Mentoringowy
              </Badge>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-deep-charcoal">
                Train The Trainer: Elite <span className="text-gold">Academy</span>
              </h2>
              <div className="w-24 h-1.5 bg-gradient-to-r from-gold to-luminal-magenta rounded-full mx-auto mb-8"></div>
              ...
              {[
                {
                  title: "Mindset Elity",
                  icon: Star,
                  gradient: "from-gold to-luminal-magenta",
                ...
                },
                {
                  ...
                  icon: Book,
                  gradient: "from-luminal-magenta to-ascension-pink",
                  description: "Dowiesz się, jak radzić sobie z trudnymi uczestnikami, jak prowadzić grupę przez techniczne labirynty i jak zawsze wyjść z twarzą z najtrudniejszej sytuacji.",
                  value: "$2,000",
                  weeks: "5-6"
                },
                {
                ...
                },
                {
                  ...
                  icon: GitMerge,
                  gradient: "from-ascension-pink to-gold",
                ...
                <div key={index} className="group relative bg-gradient-to-br from-white via-gold/5 to-white rounded-3xl p-10 border-2 border-gold/20 hover:border-gold/50 shadow-2xl hover:shadow-gold/20 transition-all duration-500 hover:-translate-y-2">

                  {/* Value Indicator */}
                  <div className="absolute top-6 right-6 bg-gold/10 text-gold px-4 py-2 rounded-full text-xs font-bold border border-gold/30">
                  ...
                  <h3 className="text-2xl font-bold mb-4 text-deep-charcoal">{feature.title}</h3>
                  <p className="text-base text-deep-charcoal/70 leading-relaxed mb-6">{feature.description}</p>

                  {/* Completion Timeline */}
                  <div className="flex items-center gap-2 text-sm text-deep-charcoal/60 pt-4 border-t border-gold/10">
      ...
      <section className="relative py-20 bg-gradient-to-b from-white via-gold/5 to-white overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 w-64 h-64 bg-neural-violet rounded-full blur-3xl animate-pulse delay-500"></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-deep-charcoal">
                Program dedykowany dla <span className="text-gold">ekspertów IT</span>
              </h2>
              <div className="w-24 h-1.5 bg-gradient-to-r from-gold to-luminal-magenta rounded-full mx-auto mb-4"></div>
              <p className="text-lg text-deep-charcoal/70 max-w-3xl mx-auto">
                Jeśli jesteś doświadczonym profesjonalistą IT i chcesz dzielić się swoją wiedzą na globalnej scenie
              </p>
            </div>
              ...
              {[
                {
                  ...
                  icon: Book,
                  description: "Specjalizacja w konkretnej technologii, doświadczenie w enterprise projects",
                  gradient: "from-neural-violet to-quantum-blue"
                },
                {
                  title: "Architekt IT",
                  icon: Crown,
                  description: "Projektowanie systemów, znajomość best practices i design patterns",
                  gradient: "from-gold to-luminal-magenta"
                },
                {
                  title: "IT Manager",
                  icon: Users,
                  description: "Zarządzanie zespołami, budżetami i projektami w środowisku tech",
                  gradient: "from-luminal-magenta to-ascension-pink"
                },
                {
                  title: "DevOps / SRE",
                  icon: Shield,
                  description: "Administracja infrastruktury, CI/CD, cloud architecture i monitoring",
                  gradient: "from-quantum-blue to-neural-violet"
                }
              ].map((persona, index) => (
                <div key={index} className="group relative bg-white rounded-2xl p-6 border-2 border-gold/20 hover:border-gold/50 shadow-lg hover:shadow-2xl hover:shadow-gold/20 transition-all duration-300 hover:-translate-y-2">
                  {/* Icon with gradient */}
                  ...
                  <h3 className="text-lg font-bold mb-3 text-deep-charcoal text-center">{persona.title}</h3>
                  <p className="text-sm text-deep-charcoal/70 text-center leading-relaxed">{persona.description}</p>
                </div>
              ))}
            </div>
            ...
            <div className="bg-gradient-to-r from-gold/10 via-luminal-magenta/10 to-gold/10 rounded-2xl p-6 border-2 border-gold/30">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-bold text-deep-charcoal mb-2">Wymagana znajomość języka angielskiego</h3>
                  <p className="text-deep-charcoal/80">
                    Materiały szkoleniowe oraz większość klientów premium (Fortune 500, rządy, NATO) wymagają
                    biegłej znajomości języka angielskiego w mowie i piśmie. To niezbędny skill dla międzynarodowych trenerów.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-2xl text-gold italic font-semibold">
              ...
              <div className="relative order-2 lg:order-1">
                ...
                <div className="absolute -bottom-6 -right-6 bg-gradient-to-br from-gold to-luminal-magenta rounded-2xl p-6 shadow-2xl border-2 border-white/20">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-white/90 font-semibold uppercase tracking-wide">Years</div>
                    <div className="text-xs text-white/90 font-semibold uppercase tracking-wide">Experience</div>
                  </div>
                </div>
              </div>
      ...
      <section className="relative py-20 bg-gradient-to-b from-white via-gold/5 to-white overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-5">
          <div className="absolute top-10 right-10 w-96 h-96 bg-gold rounded-full blur-3xl"></div>
          <div className="absolute bottom-10 left-10 w-80 h-80 bg-luminal-magenta rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-deep-charcoal">
                Ile kosztuje transformacja <span className="text-gold">od technika do trenera?</span>
              </h2>

              <p className="text-xl text-deep-charcoal/70 max-w-3xl mx-auto">
                8 tygodni intensywnej pracy, która zmieni Twoją karierę na zawsze
              </p>
            </div>

            {/* Value Stack */}
            <div className="bg-white rounded-3xl shadow-2xl border-2 border-gold/20 overflow-hidden mb-8">
              ...
              <div className="p-8">
                ...
                <div className="space-y-4 mb-8">
                  {[
                    { item: "Mindset Elity - Transformacja myślenia", value: "$3,000" },
                    { item: "Architektura Emocji - Emotional Intelligence Mastery", value: "$2,500" },
                    { item: "Warsztat Mistrza - Technical Training Excellence", value: "$2,000" },
                    { item: "System Pozyskiwania - Client Acquisition Framework", value: "$2,500" },
                    { item: "Bezcenna Sieć - Lifetime Alumni Network", value: "$5,000" },
                    { item: "8 sesji 1-on-1 mentoring (2h każda, $500/h)", value: "$8,000" },
                    { item: "Dostęp do materiałów szkoleniowych (lifetime)", value: "$2,000" },
                    { item: "Certyfikacja International IT Trainer", value: "$3,000" },
                    { item: "3 miesiące follow-up support", value: "$2,000" }
                  ].map((item, index) => (
                    <div key={index} className="flex items-center justify-between py-3 border-b border-deep-charcoal/10 last:border-0">
                      <div className="flex items-start gap-3 flex-1">
                        <CheckCircle className="w-5 h-5 flex-shrink-0 mt-0.5 text-gold" />
                        <span className="text-deep-charcoal/80">{item.item}</span>
                      </div>
                      <span className="text-deep-charcoal/60 font-semibold ml-4">{item.value}</span>
                    </div>
                  ))}
                </div>

                {/* Total value */}
                <div className="border-t-2 border-gold/30 pt-6 mb-8">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-lg text-deep-charcoal/70">Łączna wartość programu:</span>
                    <span className="text-2xl font-bold text-deep-charcoal/70 line-through">$30,000</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-2xl font-bold text-deep-charcoal">Twoja inwestycja:</span>
                    <div className="text-right">
                      <div className="text-5xl font-bold text-gold">$18,500</div>
                      <div className="text-sm text-deep-charcoal/60 mt-1">Oszczędzasz $11,500</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gold/5 rounded-2xl p-6 mb-8 border border-gold/20">
                  <h4 className="font-bold text-deep-charcoal mb-4 text-center">Opcje płatności</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-white rounded-xl p-6 border-2 border-gold shadow-lg">
                      <div className="text-center mb-3">
                        <Crown className="w-8 h-8 mx-auto mb-2 text-gold" />
                        <p className="font-bold text-deep-charcoal">Pełna płatność</p>
                      </div>
                      <p className="text-3xl font-bold text-gold text-center mb-2">$18,500</p>
                      <p className="text-xs text-center text-deep-charcoal/60">Jednorazowa płatność</p>
                      <div className="mt-4 pt-4 border-t border-gold/20">
                        ...
                        <div className="flex items-center gap-2 text-sm text-deep-charcoal/70">
                          <CheckCircle className="w-4 h-4 text-gold" />
                          <span>Priorytetowy dostęp do przyszłych programów</span>
                        </div>
                      </div>
                    </div>

                    <div className="bg-white rounded-xl p-6 border border-gold/20">
                      <div className="text-center mb-3">
                        <Shield className="w-8 h-8 mx-auto mb-2 text-deep-charcoal/60" />
                        <p className="font-bold text-deep-charcoal">Plan ratalny</p>
                      </div>
                      <p className="text-3xl font-bold text-deep-charcoal text-center mb-2">$6,500</p>
                      <p className="text-xs text-center text-deep-charcoal/60">× 3 raty miesięczne</p>
                      <div className="mt-4 pt-4 border-t border-deep-charcoal/10">
                        <p className="text-sm text-deep-charcoal/70 mb-2">1. rata: przy zapisie</p>
                        <p className="text-sm text-deep-charcoal/70 mb-2">2. rata: po 30 dniach</p>
                        <p className="text-sm text-deep-charcoal/70">3. rata: po 60 dniach</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-gold/10 via-luminal-magenta/10 to-gold/10 rounded-2xl p-6 border-2 border-gold/30">
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0">
                      <div className="w-16 h-16 bg-gradient-to-br from-gold to-luminal-magenta rounded-full flex items-center justify-center shadow-lg">
                        <Shield className="w-8 h-8 text-white" />
                      </div>
                    </div>
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-deep-charcoal mb-3">Gwarancja Premium</h4>
                      <p className="text-deep-charcoal/80 mb-3">
                        Jeśli po pierwszym tygodniu programu uznasz, że to nie dla Ciebie - zwrot 100% wpłaconej kwoty.
                        Zero pytań, zero warunków.
                      </p>
                      <p className="text-sm text-deep-charcoal/70 italic">
                        Dodatkowo: jeśli w ciągu 12 miesięcy od ukończenia programu nie zdobędziesz kontraktu szkoleniowego
                        wartego minimum $10,000, otrzymasz dodatkowe 3 miesiące mentoringu - bezpłatnie.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="relative py-20 bg-gradient-to-b from-deep-space via-quantum-blue/10 to-deep-space overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-20">
          ...
          <div className="absolute bottom-20 right-1/4 w-80 h-80 bg-luminal-magenta rounded-full blur-3xl animate-pulse delay-1000"></div>
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">
                Twoja transformacja zaczyna się <span className="text-gold">od Sesji Discovery</span>
              </h2>

              <p className="text-xl text-white/90 max-w-3xl mx-auto">
                Nie przyjmujemy każdego. To 30-minutowa kwalifikacyjna rozmowa strategiczna, podczas której sprawdzimy,
                czy jesteś odpowiednią osobą do tego programu.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  duration: "30 min",
                  description: "Analiza Twojego doświadczenia, celów i readiness do transformacji. Sprawdzamy fit obustronnie.",
                  icon: Compass
                },
                {
                  step: "02",
                  ...
                  duration: "24h",
                  description: "Otrzymujesz decision w ciągu 24h. Jeśli pasujesz - zaproszenie do programu + oferta inwestycyjna.",
                  icon: CheckCircle
                },
                {
                  step: "03",
                  title: "Onboarding",
                  duration: "7 dni",
                  description: "Po akceptacji: setup materiałów, access do platformy, scheduling pierwszej sesji mentorskiej.",
                  icon: Star
                }
              ].map((step, index) => (
                <div key={index} className="relative bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-gold/50 transition-all duration-300 hover:-translate-y-1">
                  <div className="absolute -top-4 left-6 w-12 h-12 bg-gradient-to-br from-gold to-luminal-magenta rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg border-4 border-deep-space">
                    {step.step}
                  </div>
            ...
            <div className="text-center">
              <div className="relative inline-block mb-8">
                <div className="absolute -inset-2 bg-gradient-to-r from-gold via-luminal-magenta to-gold rounded-2xl blur-xl opacity-75 animate-pulse"></div>
                <a href="https://link.siadlak.com/discovery" target="_blank" rel="noopener noreferrer">
                  <button className="relative bg-gradient-to-r from-gold to-luminal-magenta hover:from-gold/90 hover:to-luminal-magenta/90 text-white px-12 py-6 rounded-2xl text-xl font-bold shadow-2xl transition-all duration-300 hover:scale-105 flex items-center gap-3">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-white/90 text-sm">
                      To ostatnie 2 miejsca na Q1 2025. Jeśli przegapisz tę szansę, następna możliwość pojawi się
                      za pół roku - prawdopodobnie z wyższą ceną (historycznie podwyższamy inwestycję o 15-20% rocznie).
                    </p>
                  </div>
                </div>
              </div>
