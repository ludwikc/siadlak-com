  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[var(--border-radius-sm)] text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-transparent text-[var(--text-primary)] border border-[var(--border-primary)] hover:bg-[rgba(0,0,0,0.05)] hover:border-[var(--text-secondary)]",
        outline:
          "border border-[var(--border-primary)] bg-transparent text-[var(--text-primary)] hover:bg-[rgba(0,0,0,0.05)] hover:border-[var(--text-secondary)]",
        ghost:
          "bg-transparent hover:bg-[rgba(0,0,0,0.05)] text-[var(--text-primary)]",
