  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
      <div className="text-center">
        <div className="w-16 h-16 bg-twilight-indigo/20 rounded-full flex items-center justify-center mx-auto mb-4">
          <Download className="h-8 w-8 text-twilight-indigo" />
        </div>
      ...
      <div className="text-center">
        <div className="w-16 h-16 bg-twilight-indigo/20 rounded-full flex items-center justify-center mx-auto mb-4">
          <TrendingUp className="h-8 w-8 text-twilight-indigo" />
        </div>
      ...
      <div className="text-center">
        <div className="w-16 h-16 bg-twilight-indigo/20 rounded-full flex items-center justify-center mx-auto mb-4">
          <Star className="h-8 w-8 text-twilight-indigo" />
        </div>
