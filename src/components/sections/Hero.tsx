      ...
      >
        ...
        >
          ...
          >
            <h1
              id="hero-title"
              className="text-white font-heading font-bold !leading-tight animate-fade-in text-right text-5xl md:text-6xl lg:text-7xl flex flex-col items-end w-4/5 ml-auto"
            >
