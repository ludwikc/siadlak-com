          ...
          >
            ...
            <div className="p-6 sm:p-8">
              <div className="grid lg:grid-cols-3 gap-8">
                {/* Column 1 & 2: Main Navigation (2 columns) */}
                <div className="lg:col-span-2">
                  <div className="space-y-6">
                    {/* Hero Card 1: Programy rozwojowe - Full Width */}
                    <Link
                      to="/program"
                      className="block p-6 bg-gradient-to-br from-neural-blue/5 to-twilight-indigo/5 rounded-xl shadow-2xl shadow-neural-blue/30 transition-all duration-200 group border-2 border-neural-blue/50 relative overflow-hidden min-h-[140px] hover:shadow-3xl hover:-translate-y-1"
                      onClick={() => setIsDropdownOpen(false)}
                    >
                      <div className="absolute top-4 left-4 bg-gradient-to-r from-neural-blue to-twilight-indigo text-white text-xs font-bold px-4 py-2 rounded-lg shadow-lg flex items-center gap-1.5">
                        <span className="text-sm">⭐</span>
                        <span>Tu chcesz zacząć</span>
                      </div>
                      <div className="flex items-stretch justify-between pt-10 h-full">
                        <div className="flex items-center flex-1">
                          <div className="w-16 h-16 flex items-center justify-center mr-5 bg-gradient-to-br from-neural-blue to-twilight-indigo rounded-xl shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                            <Book size={32} className="text-white" />
                          </div>
                          <div>
                            <h4 className="text-2xl font-bold text-deep-charcoal mb-1.5 group-hover:text-neural-blue transition-colors">
                              Programy rozwojowe
                            </h4>
                            <p className="text-base text-deep-charcoal/70 font-medium">
                        ...
                        <div className="hidden md:flex items-center ml-4 flex-shrink-0">
                          <img
                            ...
                            className="h-full max-h-28 w-auto group-hover:scale-110 transition-transform duration-300"
                          />
                        </div>
                      </div>
                    </Link>

                    {/* Hero Card 2: Wydarzenia na żywo - Full Width */}
                    <Link
                      to="/webinar"
                      className="block p-6 bg-gradient-to-br from-growth-gold/5 to-neural-blue/5 rounded-xl shadow-xl shadow-growth-gold/20 transition-all duration-200 group border-2 border-growth-gold/40 hover:border-growth-gold/60 relative overflow-hidden min-h-[140px] hover:shadow-2xl hover:shadow-growth-gold/30 hover:-translate-y-1"
                      onClick={() => setIsDropdownOpen(false)}
                    >
                      <div className="absolute top-4 right-4 w-fit">
                        <div className="relative">
                          <div className="absolute inset-0 bg-gradient-to-r from-growth-gold to-neural-blue rounded-lg blur-md opacity-70"></div>
                          <div className="relative bg-gradient-to-r from-growth-gold to-neural-blue text-white text-xs font-bold px-4 py-2 rounded-lg shadow-lg flex items-center gap-1.5">
                            <span className="text-sm">🔥</span>
                      ...
                      <div className="flex items-center mt-3">
                        <div className="w-16 h-16 flex items-center justify-center mr-5 bg-gradient-to-br from-growth-gold to-neural-blue rounded-xl shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                          <Video size={32} className="text-white" />
                        </div>
                        <div>
                          <h4 className="text-2xl font-bold text-deep-charcoal mb-1.5 group-hover:text-growth-gold transition-colors">
                            Wydarzenia na żywo
                          </h4>
                          <p className="text-base text-deep-charcoal/70 font-medium">
                ...
                <div className="lg:col-span-1">
                  <div className="sticky top-6 p-6 bg-gradient-to-br from-neural-blue/5 to-twilight-indigo/5 rounded-xl border-2 border-neural-blue/30 hover:border-twilight-indigo/30 shadow-lg transition-all duration-300">
                    ...
                    <p className="text-sm text-deep-charcoal/80 mb-6 font-medium">
                      🎉 Witaj z powrotem!
                    </p>
                    ...
                    <div className="space-y-3">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center p-4 bg-white rounded-lg hover:shadow-md transition-all duration-200 group border border-slate-200 hover:border-neural-blue/50 hover:-translate-y-0.5"
                      >
                        <Home
                          size={18}
                          className="text-neural-blue group-hover:text-twilight-indigo mr-3 transition-colors flex-shrink-0"
                        />
