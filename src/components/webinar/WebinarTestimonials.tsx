...
const testimonials = [
  {
    ...
    quote: "Webinary Ludwika zmieniły moje podejście do własnej kariery. W ciągu 6 miesięcy od uczestnictwa założyłem własną firmę konsultingową i potroiłem swoje przychody.",
    image: "/placeholder.svg"
  },
  {
    name: "Anna W.",
    role: "Frontend Developer → UX Consultant",
    quote: "To, co wyróżnia Ludwika, to jego umiejętność łączenia wiedzy technicznej z biznesową. Dzięki jego webinarom i mentoringowi znalazłam swoją niszę w UX i teraz pracuję na własnych zasadach.",
    image: "/placeholder.svg"
  },
  {
    name: "Piotr S.",
    role: "DevOps Engineer → B2B Tech Consultant",
    quote: "Ludwik ma dar przekazywania złożonych koncepcji w przystępny sposób. Jego webinary dały mi nie tylko wiedzę, ale też motywację do działania. Teraz pracuję zdalnie dla klientów z USA i zarabiam 4x więcej niż na etacie.",
    image: "/placeholder.svg"
  }
];
      ...
      <div className="container max-w-6xl mx-auto px-4">
        ...
        <div className="mt-12 flex justify-center">
          <div className="flex items-center space-x-4 bg-white/80 dark:bg-deep-space/80 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-700 dark:text-gray-300">uczestników ocenia webinary Ludwika jako "warte każdej minuty"</p>
          </div>
        </div>
      </div>
    </section>
